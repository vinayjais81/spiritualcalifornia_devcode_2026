...
CREATE INDEX "tour_departures_tourId_startDate_idx" ON "tour_departures"("tourId", "startDate");
CREATE INDEX "tour_departures_status_startDate_idx" ON "tour_departures"("status", "startDate");
...
CREATE TABLE "tour_booking_travelers" (
    "id" TEXT NOT NULL,
...
CREATE INDEX "tour_booking_travelers_bookingId_idx" ON "tour_booking_travelers"("bookingId");
...
ALTER TABLE "ticket_purchases" ADD COLUMN IF NOT EXISTS "status" "TicketStatus" NOT NULL DEFAULT 'PENDING';
