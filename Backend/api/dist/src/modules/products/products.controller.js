...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Create a draft product (published when guide goes live)' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete a product owned by the authenticated guide' }),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
