...
async function main() {
    ...
    if (!(await prisma.user.findUnique({ where: { email: adminEmail } }))) {
        const adminUser = await prisma.user.create({
            data: {
                ...
                isActive: true,
                roles: { create: [{ role: client_1.Role.SUPER_ADMIN }, { role: client_1.Role.ADMIN }] },
            },
        });
        ...
        if (!user) {
            user = await prisma.user.create({
                data: {
                    ...
                    isEmailVerified: true,
                    isActive: true,
                    roles: { create: [{ role: client_1.Role.SEEKER }] },
                    seekerProfile: {
                        create: {
                            location: s.location,
    ...
    const guideData = [
        {
            ...
            services: [
                { name: 'Private Meditation Session', price: 120, durationMin: 60, type: client_1.ServiceType.IN_PERSON, description: 'One-on-one personalized meditation session tailored to your goals, whether stress reduction, sleep improvement, or spiritual development. Held at my peaceful home studio in Los Gatos.' },
                { name: 'Mindfulness for Executives (Virtual)', price: 150, durationMin: 60, type: client_1.ServiceType.VIRTUAL, description: 'Corporate mindfulness coaching for busy tech executives. Learn science-backed techniques to improve focus, decision-making, and leadership presence.' },
                { name: 'Breathwork Journey Session', price: 95, durationMin: 90, type: client_1.ServiceType.IN_PERSON, description: 'Transformative breathwork session using conscious connected breathing to release stored tension and access deeper states of clarity and peace.' },
            ],
        },
        {
            ...
            services: [
                { name: 'Initial Acupuncture Consultation & Treatment', price: 175, durationMin: 90, type: client_1.ServiceType.IN_PERSON, description: 'Comprehensive first-visit includes detailed intake, pulse and tongue diagnosis, and full acupuncture treatment with optional cupping or gua sha.' },
                { name: 'Follow-Up Acupuncture Treatment', price: 110, durationMin: 60, type: client_1.ServiceType.IN_PERSON, description: 'Ongoing acupuncture treatment session for established patients. Includes brief check-in and full needle treatment.' },
                { name: 'TCM Herbal Consultation', price: 85, durationMin: 45, type: client_1.ServiceType.IN_PERSON, description: 'Personalized Chinese herbal medicine prescription consultation. Custom formula designed for your specific constitution and health goals.' },
            ],
        },
        {
            ...
            services: [
                { name: 'Executive Coaching Session', price: 300, durationMin: 60, type: client_1.ServiceType.VIRTUAL, description: 'One-on-one coaching session for senior leaders and executives. Topics include leadership presence, team dynamics, strategic thinking, and personal sustainability.' },
                { name: 'Purpose Discovery Intensive', price: 450, durationMin: 120, type: client_1.ServiceType.VIRTUAL, description: 'Deep 2-hour coaching intensive to clarify your core values, identify your unique strengths, and craft a compelling vision for your next chapter.' },
                { name: 'Career Transition Coaching', price: 250, durationMin: 75, type: client_1.ServiceType.VIRTUAL, description: 'Structured coaching for professionals navigating career change, whether pivoting industries, starting a business, or returning from a sabbatical.' },
            ],
        },
        {
            ...
            services: [
                { name: 'Private Yoga Session', price: 130, durationMin: 75, type: client_1.ServiceType.IN_PERSON, description: 'Personalized one-on-one yoga session designed for your body, goals, and current condition. Includes posture alignment, breathwork, and Ayurvedic lifestyle guidance.' },
                { name: 'Ayurvedic Wellness Consultation', price: 110, durationMin: 60, type: client_1.ServiceType.IN_PERSON, description: 'Learn your Ayurvedic dosha type and receive personalized recommendations for diet, daily routine, herbs, and yoga practices to restore balance.' },
                { name: 'Restorative Yoga for Stress & Sleep', price: 100, durationMin: 90, type: client_1.ServiceType.IN_PERSON, description: 'Gentle, therapeutic restorative yoga session using bolsters, blankets, and props. Perfect for those dealing with insomnia, anxiety, or adrenal fatigue.' },
            ],
        },
        {
            ...
            services: [
                { name: 'Hypnotherapy Session', price: 180, durationMin: 90, type: client_1.ServiceType.IN_PERSON, description: 'Full hypnotherapy session including pre-talk, induction, therapeutic work, and integration. Effective for anxiety, habits, phobias, confidence, and performance enhancement.' },
                { name: 'Smoking Cessation Program (3 Sessions)', price: 480, durationMin: 90, type: client_1.ServiceType.IN_PERSON, description: 'Comprehensive 3-session hypnotherapy program specifically designed for smoking cessation. Includes personalized recordings for home practice.' },
                { name: 'Virtual Hypnotherapy Session', price: 160, durationMin: 75, type: client_1.ServiceType.VIRTUAL, description: 'Online hypnotherapy session via Zoom. Equally effective as in-person for most issues. Requires a quiet, private space and stable internet connection.' },
            ],
        },
        {
            ...
            services: [
                { name: 'Reiki Healing Session', price: 110, durationMin: 60, type: client_1.ServiceType.IN_PERSON, description: 'Full Reiki energy healing session in a peaceful, sacred space. Includes chakra assessment, hands-on Reiki, crystal placement, and an oracle card reading to close.' },
                { name: 'Reiki + Sound Bath Combo', price: 145, durationMin: 90, type: client_1.ServiceType.IN_PERSON, description: 'Deeply relaxing combined session featuring full Reiki treatment accompanied by live crystal singing bowls for an immersive healing experience.' },
                { name: 'Distance Reiki Session', price: 85, durationMin: 45, type: client_1.ServiceType.VIRTUAL, description: 'Remote Reiki healing session with equal effectiveness to in-person treatment. Includes a detailed written report of energy observations and intuitive insights.' },
            ],
        },
        {
            ...
            services: [
                { name: 'Private QiGong Instruction', price: 95, durationMin: 60, type: client_1.ServiceType.IN_PERSON, description: 'Personalized QiGong coaching session. Learn foundational forms, standing meditation, and targeted exercises for your specific health goals.' },
                { name: 'Medical QiGong Healing Session', price: 120, durationMin: 75, type: client_1.ServiceType.IN_PERSON, description: 'Therapeutic QiGong session focused on restoring energy flow, addressing specific health conditions, and teaching self-healing exercises you can practice daily.' },
            ],
        },
        {
            ...
            services: [
                { name: 'Art Therapy Individual Session', price: 160, durationMin: 60, type: client_1.ServiceType.IN_PERSON, description: 'Individual art therapy session in a fully equipped studio. No art experience needed. Materials provided. A safe, creative space to explore what words alone cannot express.' },
                { name: 'Grief & Loss Processing Session', price: 160, durationMin: 75, type: client_1.ServiceType.IN_PERSON, description: 'Specialized art therapy session for those navigating grief and loss. Combines expressive arts with somatic awareness and gentle therapeutic dialogue.' },
            ],
        },
        {
            ...
            services: [
                { name: 'Private Sound Healing Session', price: 130, durationMin: 75, type: client_1.ServiceType.IN_PERSON, description: 'Private one-on-one sound bath using crystal and Tibetan singing bowls, gong, and other sacred instruments. Deeply restoring for the nervous system.' },
                { name: 'Sound Bath & Meditation Journey', price: 110, durationMin: 90, type: client_1.ServiceType.IN_PERSON, description: 'Extended session combining guided meditation, chakra toning, and full sound bath immersion. Ideal for those seeking a profound reset.' },
            ],
        },
        {
            ...
            services: [
                { name: 'Individual Music Therapy Session', price: 140, durationMin: 60, type: client_1.ServiceType.IN_PERSON, description: 'One-on-one music therapy session using live instruments, guided listening, songwriting, and rhythmic exercises tailored to your therapeutic goals.' },
                { name: 'Group Drum Circle Experience', price: 40, durationMin: 90, type: client_1.ServiceType.IN_PERSON, description: 'Community drum circle open to all skill levels. No musical experience needed — drums provided. A joyful, stress-releasing group experience through shared rhythm.' },
                { name: 'Virtual Music & Mindfulness Session', price: 95, durationMin: 45, type: client_1.ServiceType.VIRTUAL, description: 'Online music therapy session combining guided listening, toning exercises, and mindfulness practices. Perfect for remote workers seeking creative stress relief.' },
            ],
        },
    ];
    const guideUsers = [];
        ...
        if (!user) {
            user = await prisma.user.create({
                data: {
                    ...
                    isEmailVerified: true,
                    isActive: true,
                    roles: { create: [{ role: client_1.Role.GUIDE }, { role: client_1.Role.SEEKER }] },
                },
            });
        }
    ...
    const bookingScenarios = [
        { seekerIdx: 0, serviceIdx: 0, slotIdx: 0, status: client_1.BookingStatus.COMPLETED, daysAgo: 20 },
        { seekerIdx: 0, serviceIdx: 3, slotIdx: 1, status: client_1.BookingStatus.COMPLETED, daysAgo: 14 },
        { seekerIdx: 1, serviceIdx: 7, slotIdx: 2, status: client_1.BookingStatus.COMPLETED, daysAgo: 10 },
        { seekerIdx: 1, serviceIdx: 6, slotIdx: 3, status: client_1.BookingStatus.CONFIRMED, daysAgo: -5 },
        { seekerIdx: 2, serviceIdx: 12, slotIdx: 4, status: client_1.BookingStatus.COMPLETED, daysAgo: 25 },
        { seekerIdx: 2, serviceIdx: 13, slotIdx: 5, status: client_1.BookingStatus.COMPLETED, daysAgo: 7 },
        { seekerIdx: 3, serviceIdx: 1, slotIdx: 6, status: client_1.BookingStatus.CONFIRMED, daysAgo: -3 },
        { seekerIdx: 3, serviceIdx: 9, slotIdx: 7, status: client_1.BookingStatus.COMPLETED, daysAgo: 18 },
        { seekerIdx: 4, serviceIdx: 17, slotIdx: 8, status: client_1.BookingStatus.COMPLETED, daysAgo: 12 },
        { seekerIdx: 5, serviceIdx: 4, slotIdx: 9, status: client_1.BookingStatus.COMPLETED, daysAgo: 30 },
        { seekerIdx: 5, serviceIdx: 5, slotIdx: 10, status: client_1.BookingStatus.CANCELLED, daysAgo: 8 },
        { seekerIdx: 0, serviceIdx: 16, slotIdx: 11, status: client_1.BookingStatus.COMPLETED, daysAgo: 45 },
    ];
    ...
    for (const scenario of bookingScenarios) {
        ...
        const booking = await prisma.booking.create({
            data: {
                ...
                completedAt: scenario.status === client_1.BookingStatus.COMPLETED ? past(scenario.daysAgo - 1) : null,
                cancelledAt: scenario.status === client_1.BookingStatus.CANCELLED ? past(scenario.daysAgo) : null,
            },
        });
        if (scenario.status !== client_1.BookingStatus.CANCELLED) {
    ...
    let reviewCount = 0;
    const seekerUserObjs = await prisma.user.findMany({ where: { roles: { some: { role: client_1.Role.SEEKER } } } });
    const guideUserObjs = await prisma.user.findMany({ where: { roles: { some: { role: client_1.Role.GUIDE } } } });
    ...
    const eventData = [
        {
            ...
            type: client_1.EventType.IN_PERSON,
            location: 'Los Gatos Community Center, 208 E Main St, Los Gatos, CA 95030',
            daysFromNow: 8,
            durationHours: 2.5,
        ...
        },
        {
            ...
            type: client_1.EventType.VIRTUAL,
            location: null,
            daysFromNow: 5,
            durationHours: 1,
            tiers: [
        ...
        },
        {
            ...
            type: client_1.EventType.SOUL_TRAVEL,
            location: 'Redwood Retreat Center, 2400 Bear Creek Rd, Boulder Creek, CA 95006',
            daysFromNow: 35,
            durationHours: 48,
            tiers: [
    ...
    const tourData = [
        {
            ...
            departures: [
                { daysFromNow: 38, durationDays: 9, capacity: 12, spotsTaken: 7 },
                { daysFromNow: 95, durationDays: 9, capacity: 12, spotsTaken: 3 },
                { daysFromNow: 175, durationDays: 9, capacity: 12, spotsTaken: 0 },
            ],
            itinerary: [
